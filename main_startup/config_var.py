...
class Config((object)):
    ...
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC", "https://telegra.ph//file/3f97ad3ad0a68dd759060.jpg"
    )
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/HairyPotah02/JuanSecurityBotv1"
    )
    ALIVE_IMG = os.environ.get(
        "ALIVE_IMG", "https://telegra.ph//file/3f97ad3ad0a68dd759060.jpg"
    )
    U_BRANCH = "master"
