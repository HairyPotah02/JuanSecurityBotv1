...
"""
        ...
        nice_text = f"**JuanUserBot Commands** \n**Juan Security Bot Version :** __{friday_version}__ \n**PyroGram Version :** __{__version__}__ \n**Total Plugins Loaded :** __{total_}__"
...
async def black_menu(client, cb):
    ...
    if Config.LOAD_UNOFFICIAL_PLUGINS:
        total_ = len(XTRA_CMD_LIST) + len(CMD_LIST)
    nice_text = f"**Juan UserBot Commands** \n**Juan Version :** __{friday_version}__ \n**PyroGram Version :** __{__version__}__ \n**Total Plugins Loaded :** __{total_}__"
...
async def update_it(client, cb):
    ...
    try:
        ...
        return await cb.edit_message_text(
            "`Invalid Git Command. Please Report This Bug To @EngrJuanMala`",
            reply_markup=InlineKeyboardMarkup(bttn)
        )
...
async def get_back_vro(client, cb):
    ...
    nice_text = f"**JuanUserBot Commands & Help Menu!** \n\n**Juan Version :** __{friday_version}__ \n**PyroGram Version :** __{__version__}__ \n**Total Plugins Loaded :** __{len(CMD_LIST)}__"
...
async def give_plugin_cmds(client, cb):
    ...
    help_string += "\n\n**(C) @EngrJuanMala** ".format(plugin_name)
    await cb.edit_message_text(
        help_string,
        reply_markup=InlineKeyboardMarkup(
            [
